# @file
# Script to Build LG G4 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("LGG4Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('LGG4', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "LGG4Pkg/LGG4.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "LGG4", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "LGG4Pkg/LGG4.dsc", "Platform Hardcoded")
